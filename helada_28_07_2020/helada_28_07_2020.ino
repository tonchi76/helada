...
void setup() {
 ...
 client.setCallback(callback);
          //*****  TOPIC  ******alerta
  String alerta = "/" + USERNAME + "/" + "alerta";
  alerta.toCharArray(ALERTA, 50);        
...
if (currentMillis - previousMillis >= 8000) { //envia la temperatura cada 25 segundos
